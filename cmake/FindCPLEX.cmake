...
if(NOT CPLEX_ROOT)
  if(WIN32)
    if(EXISTS "C:/Program Files/IBM/ILOG/CPLEX_Studio221")
      set(CPLEX_ROOT "C:/Program Files/IBM/ILOG/CPLEX_Studio221")
    elseif(EXISTS "C:/Program Files/IBM/ILOG/CPLEX_Studio1210")
      set(CPLEX_ROOT "C:/Program Files/IBM/ILOG/CPLEX_Studio1210")
    else()
      message(FATAL_ERROR "CPLEX_ROOT not found in default Windows paths")
    endif()
  elseif(DEFINED ENV{UNIX_CPLEX_DIR})
    set(CPLEX_ROOT $ENV{UNIX_CPLEX_DIR})
  elseif(DEFINED ENV{CPLEX_ROOT})
    set(CPLEX_ROOT $ENV{CPLEX_ROOT})
  else()
    set(CPLEX_ROOT "/opt/ibm/ILOG/CPLEX_Studio221/")
  endif()
endif()
...
if(CPLEX_FOUND AND NOT TARGET CPLEX::CPLEX)
  ...
  elseif(MSVC)
    if(CPLEX_ROOT MATCHES "CPLEX_Studio221")
      set_target_properties(CPLEX::CPLEX PROPERTIES
        IMPORTED_LOCATION "${CPLEX_ROOT}/cplex/lib/x64_windows_msvc14/stat_mda/cplex2210.lib")
    elseif(CPLEX_ROOT MATCHES "CPLEX_Studio1210")
      set_target_properties(CPLEX::CPLEX PROPERTIES
        IMPORTED_LOCATION "${CPLEX_ROOT}/cplex/lib/x64_windows_msvc14/stat_mda/cplex12100.lib")
    else()
      message(FATAL_ERROR "Unsupported CPLEX version found in Windows: ${CPLEX_ROOT}")
    endif()
  else()
